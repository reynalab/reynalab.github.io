...
* Campbell K, __Reyna MA__. MOSAIC: model-based, subgroup-aware identification of driver mutations in cancer. In: Research in Computational Molecular Biology Computational Cancer Biology. 2026.

* Campbell K, Jreich R, Buclez J, Balaji S, Parikh R, __Reyna MA__, Bozkurt S. Leveraging large language models for extracting social determinants of health in real-world clinical notes. In: IEEE International Conference on Healthcare Informatics (ICHI). 2026.
